...
\begin{document}
    ...
    Let ${\mathfrak{C} = (\times_{t\in T}\Omega_t, \otimes_{t\in T}\mathcal{E}_t, \mathbb{P}, \mathbb{K})}$ be a causal space and ${X,Y\in T}$ be distinct variables. Then, 
    \begin{align*}
    K_{X\to Y}: \Omega_X\times \mathcal{H}_Y &\to [0,1]\\
                (\omega_X, A)&\mapsto K_X(\omega_X, \times_{i\in T\setminus \{X, Y\}}\Omega_i\times \{\omega_X\}\times \pi_y(A))
    \end{align*}
