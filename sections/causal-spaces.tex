...
\begin{document}
    ...
    \begin{align*}
        K_{U\to V}: \Omega_U\times \mathcal{H}_V &\to [0,1]\\
                (\omega_U, A)&\mapsto K_X(\omega_U, \prod_{i\in T\setminus \{U\cup V\}}\Omega_i\times \{\omega_U\}\times A_V)
    \end{align*}
    ...
    \label{ex:Kerneles-between-variables-in-the-two-binary-variable-case}
