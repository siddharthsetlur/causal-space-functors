...
\begin{document}
    ...
    \end{proof}
    The takeaway here is that the interventional distribution of an event $B\in \mathcal{H}$ upon intervening on ${\omega\in\Omega_S}$ is completely determined by the intersection with events whose $\pi_S$-projection contains ${\omega_S}$ 
\end{document}